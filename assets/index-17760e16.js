...
<g>
  ...
  `}soundPick(){this.solitaire.effect&&this.solitaire.pickSound()}soundShuffle(){this.solitaire.effect&&this.solitaire.shuffleSound()}playBgm(){}}var E,K,M,j;class v{constructor(e,t){m(this,E);m(this,M);c(this,"type","back");c(this,"number",0);c(this,"selected",!1);c(this,"state","deck");c(this,"color","none");c(this,"image","");c(this,"isOpen",!1);c(this,"column",-1);this.type=e,this.number=t,h(this,M,j).call(this),h(this,E,K).call(this),this.updateState("deck")}updateState(e){this.state=e}updateColumn(e){return this.column=e,this}open(){this.isOpen=!0}}E=new WeakSet,K=function(){this.image=le(this.type,this.number)},M=new WeakSet,j=function(){switch(this.type){case"back":this.color="none";break;case"diamond":this.color="red";break;case"heart":this.color="red";break;case"spade":this.color="black";break;case"clover":this.color="black";break;default:this.color="none";break}};var k,_,y,P,S,A,C,D;class fe{constructor(e){m(this,k);m(this,y);m(this,S);m(this,C);c(this,"empty",new v("empty",0));c(this,"back",new v("back",0));c(this,"mode","development");c(this,"selector",[null,null]);c(this,"deck",{heart:[],diamond:[],spade:[],clover:[]});c(this,"store",[]);c(this,"pick",[]);c(this,"stack",{heart:[],diamond:[],spade:[],clover:[]});c(this,"ground",[[],[],[],[],[],[],[]]);c(this,"score",0);c(this,"move",0);c(this,"compareDeck",[0,0]);c(this,"themeIndex",0);c(this,"currentTheme",g[0]);c(this,"effect",!0);c(this,"bgm",!1);c(this,"bgmList");typeof e.mode=="number"?this.mode=e.mode?"development":"production":this.mode=e.mode||"development",h(this,k,_).call(this),this.mode==="development"?h(this,y,P).call(this):h(this,S,A).call(this),h(this,C,D).call(this),this.setBGM()}setBGM(){this.bgmList=new Audio,this.bgmList.muted=!0,this.bgmList.volume=ue,this.setRandomBgm(),this.bgmList.addEventListener("ended",(()=>{this.setRandomBgm()}).bind(this))}bgmStart(){this.bgmList.muted=!1,this.bgmList.play()}bgmOff(){this.bgmList.muted=!0,this.bgmList.pause()}setRandomBgm(){const e=he.filter(s=>s!==this.bgmList.currentSrc.replace(location.origin,"")),t="/new-solitaire"+e[Math.floor(e.length*Math.random())];this.bgmList.src=t,this.bgm&&this.bgmList.play();const i=this.bgmList.src.split("daehanghaesidae_")[1];b()&&(b().style.display=i?"inline-block":"none",b().innerHTML=`<span id="slide">${i}</span>`||"",T()&&(T().dataset.content=i||""))}pickSound(){const e=new Audio("/new-solitaire"+F.pick);e.currentTime=.02,e.volume=.6,e.play()}shuffleSound(){const e=new Audio("/new-solitaire"+F.shuffle);e.currentTime=.01,e.volume=.5,e.play()}randomTheme(){this.currentTheme=g[Math.floor(g.length*Math.random())]}nextTheme(){this.themeIndex+=1,this.currentTheme=g[this.themeIndex%g.length]}countUpScore(){this.score+=1}countUpMove(){this.move+=1}regame(){this.selector=[null,null],this.deck={heart:[],diamond:[],spade:[],clover:[]},this.empty=new v("empty",0),this.back=new v("back",0),this.store=[],this.pick=[],this.stack={heart:[],diamond:[],spade:[],clover:[]},this.ground=[[],[],[],[],[],[],[]],this.score=0,this.move=0,h(this,k,_).call(this),this.mode==="development"?h(this,y,P).call(this):h(this,S,A).call(this),h(this,C,D).call(this)}findUsableColumn(){const e=this.ground.findIndex((i,s)=>i.length<s+1),t=this.ground[e];return[e,t]}addGroundColumn(e){const[t,i]=this.findUsableColumn();e.updateState("ground"),e.updateColumn(t),i.push(e),i.length===t+1&&e.open()}asList(){return Object.values(this.deck).flat(1)}getCardInDecks(){return this.asList().filter(e=>e.state==="deck")}getCardInGrounds(){return this.asList().filter(e=>e.state==="ground")}getCardInStacks(){return this.asList().filter(e=>e.state==="stack")}getCardInPicks(){return this.asList().filter(e=>e.state==="pick")}compareWith(e,t){return this.isStackableColorType(e,t)&&this.isStackableNumber(e,t)}isStackableColorType(e,t){return e.color!==t.color}isStackableNumber(e,t){return e.number+1===t.number}isStackDirectly(e){const t=this.stack[e.type],i=t.slice(-1)[0],s=e.column;if(e.state==="pick"){const o=this.pick,n=o.findIndex(d=>d.number===e.number&&d.type===e.type);if(n>-1&&(t.length===0&&e.number===1||i&&i.number+1===e.number))return o.splice(n)[0],this.moveToStack(e),!0}else if(this.ground[s]&&e.state!=="stack"){const o=this.ground[s].findIndex(n=>n.number===e.number&&n.type===e.type);if(o>-1&&(t.length===0&&e.number===1||i&&i.number+1===e.number)){const n=this.ground[s].splice(o)[0];return this.afterCardOpen(s),this.moveToStack(n),!0}}return!1}moveToGround(e,t){e.updateColumn(t),e.updateState("ground")}moveToStack(e){e.updateColumn(-1),e.updateState("stack"),this.stack[e.type].push(e)}moveToColumn(e,t){const i=e[0],s=i.column;if(i.state==="stack"){const o=this.stack[i.type].findIndex(n=>n.number===i.number&&n.type===i.type);if(o>-1){const n=this.stack[i.type].splice(o);this.ground[t].push(...n),this.afterCardOpen(t),this.moveToGround(i,t)}}else if(i.state==="ground"){const o=this.findOrderInColumn(i),n=this.ground[s].splice(o);this.ground[t].push(...n.map(d=>d.updateColumn(t))),this.afterCardOpen(s),this.moveToGround(i,t)}else if(i.state==="pick"){const o=this.findOrderInPickList(i),n=this.pick.splice(o);this.ground[t].push(...n.map(d=>d.updateColumn(t))),this.moveToGround(i,t)}}afterCardOpen(e){this.ground[e].slice(-1)[0]&&(this.ground[e].slice(-1)[0].isOpen=!0)}findOrderInColumn(e){return this.ground[e.column].findIndex(t=>t.type===e.type&&t.number===e.number)}findOrderInPickList(e){return this.pick.findIndex(t=>t.type===e.type&&t.number===e.number)}clearSelector(){this.selector[0]=null,this.selector[1]=null}}k=new WeakSet,_=function(){for(let e of u.TYPES)for(let t=1;t<=u.AMOUNT;t++){const i=new v(e,t);this.deck[e].push(i)}},y=new WeakSet,P=function(){const e=["heart","spade","diamond","clover"];for(let t=12;t>=0;t--){for(let i of e){const s=this.deck[i][t],o=e.findIndex(n=>n===i);s.updateState("ground"),s.updateColumn(o),s.open(),this.ground[o].push(s)}e.push(e.shift())}},S=new WeakSet,A=function(){for(let e=0;e<28;e++){const t=Math.floor(Math.random()*u.TYPES.length),i=Math.floor(Math.random()*u.AMOUNT),s=this.deck[u.TYPES[t]][i];if(s.state==="ground"){e--;continue}this.addGroundColumn(s)}},C=new WeakSet,D=function(){const e=this.getCardInDecks();for(;e.length!==0;){const t=e.splice(Math.floor(Math.random()*e.length),1)[0];this.store.push(t)}};const Y=new fe({mode:0}),J=new pe(Y);new se(Y,J);J.render();
